...
@Schema(name = "TemplateActivity", description = "Activity templates defined in the signing process.")
@JsonPropertyOrder(
        {
...
public class TemplateActivity extends ContextVersionableAuditModel implements IdModel<Long> {
    ...
    @Schema(name = "Unique id of the template", required = false)
    private Long id;
    ...
    @Schema(name = "The activity execution type", required = true)
    ...
    @Schema(name = "The executor HANDLEBARS that must give the activity parameters", required = false)
    @Column(name = "executor_expr2", length = 3000)
    private String executorExpr2;

    @Schema(name = "The sub status SPEL", required = false)
    @Column(name = "system_memo_expr2", length = 1000)
    private String systemMemoExpr2;

    @Schema(name = "The entity name SPEL", required = false)
    @Column(name = "entity_name_expr", length = 1000)
    private String entityNameExpr;

    @Schema(name = "The entity id SPEL", required = false)
    @Column(name = "entity_id_expr", length = 1000)
    private String entityIdExpr;

    @Schema(name = "The process activity parameters SPEL", required = false)
    ...
    @Schema(name = "The memo default visibility", required = false)
    @Column(name = "visibility_default")
    @Enumerated(EnumType.ORDINAL)
    private EventVisibility visibilityDefault;

    @Schema(name = "The privacy id SPEL", required = false)
    @Column(name = "privacy_id_expr", length = 1000)
    private String privacyIdExpr;

    @Schema(name = "The priority id SPEL (lower is more important)", required = false)
    @Column(name = "priority_expr", length = 1000)
    private String priorityExpr;

    @Schema(name = "The event activity execution type", required = false)
