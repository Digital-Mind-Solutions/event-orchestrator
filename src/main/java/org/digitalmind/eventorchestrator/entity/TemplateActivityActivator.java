...
@Schema(description = "Template activator used to qualify the activity to a process execution.")
@JsonPropertyOrder(
        {
...
public class TemplateActivityActivator extends ContextVersionableAuditModel implements IdModel<Long> {
    ...
    @Schema(description = "Unique id of the template activator")
    private Long id;

    @Column(name = "template_id")
    @NonNull
    @Schema(description = "The id of the template activity")
    ...
    @Schema(description = "The parent process memo code that can activate this template")
    @Column(name = "parent_code")
    private String parentCode;

    @Schema(description = "The parent process memo status that can activate this template")
    @Column(name = "parent_status")
    private String parentStatus;

    @Schema(description = "The order for activating this template")
    @Column(name = "priority")
    private int priority;


//    @Schema(description = "The parent activity substatus that can activate this template")
//    @Column(name = "parent_sub_status")
//    @JsonIgnore
//    private String parentSubStatus;

    @Schema(description = "The usecase that can activate this template")
    @Column(name = "usecase")
